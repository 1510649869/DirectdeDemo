...
TerrainClass::TerrainClass(IDirect3DDevice9* pDevice)
{
	//给各个成员变量赋初值  
...
BOOL TerrainClass::InitTerrainMyself()
{
...
BOOL TerrainClass::RenderTerrain(D3DXMATRIX *pMatWorld, BOOL bDrawFrame /* = false */)
{
